...
%fit agent data to both correct and wrong model and calculate AICs
 ...
 wrapper_fitting_correct_model('outputs/simulations_3_1_correct_model_agents.csv');
...
% %Generate 1000 agents using the WRONG model of the task
 ...
 output_file_name1 = 'outputs/simulations_3_2_wrong_model_agents.csv';
 output_file_name2 = 'outputs/simulations_3_2_wrong_model_params.csv';
...
% %behavior would qualtify as model free in correct task
 ...
 output_file_name1 = 'outputs/simulations_3_3_model_based_wrong_model_agents.csv';
 output_file_name2 = 'outputs/simulations_3_3_wrong_model_params.csv';
 wrapper_model_wrong(w, output_file_name1, output_file_name2);
