...
csvwrite_with_headers('outputs/simulations_3_1_correct_model_agents.csv', agents, header_sims);
csvwrite_with_headers('outputs/simulations_3_1_correct_model_params.csv', params, header_params);
