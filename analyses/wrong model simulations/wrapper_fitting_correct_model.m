...
csvwrite_with_headers('outputs/simulations_3_1_fit_params_correct_model.csv',...
    results1, header_params);
csvwrite_with_headers('outputs/simulations_3_1_fit_params_wrong_model.csv',...
    results2, header_params);

csvwrite_with_headers('outputs/AIC_simulations_3_1_correct_model.csv',...
    aic_correct_model, header_aic);
csvwrite_with_headers('outputs/AIC_simulations_3_1_wrong_model.csv', ...
