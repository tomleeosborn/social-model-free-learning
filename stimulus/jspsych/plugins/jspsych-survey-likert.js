...
jsPsych.plugins['survey-likert'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += ".jspsych-survey-likert-statement { display:block; font-size: 15px; padding-top: 10px; margin-bottom:4px; }"+
      ...
      ".jspsych-survey-likert-opt-label { line-height: 1.1em; color: #fff; }"+
